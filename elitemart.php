...
<section class="section-padding bg-dark text-white" id="delivery">
    <div class="container">
        <div class="row align-items-center text-center text-lg-start">
            <div class="col-lg-7" data-aos="fade-right">
                <h2 class="display-5 fw-bold mb-3">Fast & Reliable Delivery</h2>
                <p class="lead mb-0 opacity-75">We offer same-day and next-day delivery slots for online orders. Our
                    efficient logistics ensure your groceries arrive promptly and in perfect condition. Enjoy express
                    options for urgent needs.</p>
            </div>
            <div class="col-lg-5 text-lg-end mt-4 mt-lg-0" data-aos="fade-left">
                <div class="delivery-status p-4 border border-secondary border-opacity-25 rounded-4">
                    <div class="d-flex align-items-center justify-content-center justify-content-lg-end mb-2">
                        <span class="status-dot pulse me-3"></span>
                        <h4 class="mb-0">Available in Your Area</h4>
                    </div>
                    <p class="small mb-0 opacity-50">Current average delivery time: <strong>45 mins</strong></p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="accordion accordion-flush" id="martFaq">
                    ...
                    <div class="accordion-item shadow-sm rounded-3 mb-3 border-0">
                        ...
                        <div id="faq1" class="accordion-collapse collapse" data-bs-parent="#martFaq">
                            <div class="accordion-body text-muted">
                                We use a controlled supply chain, cold-chain logistics for temperature-sensitive items,
                                and regular quality checks to guarantee freshness from the moment it leaves the farm
                    ...
                    <div class="accordion-item shadow-sm rounded-3 mb-3 border-0">
                        ...
                        <div id="faq2" class="accordion-collapse collapse" data-bs-parent="#martFaq">
                            <div class="accordion-body text-muted">
                                Yes! Join our Elite Rewards program to enjoy member-exclusive deals, seasonal
                                promotions, and earn rewards points on every purchase which can be redeemed for future
                                grocery shopping.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item shadow-sm rounded-3 mb-3 border-0">
                        ...
                        <div id="faq3" class="accordion-collapse collapse" data-bs-parent="#martFaq">
                            <div class="accordion-body text-muted">
                                Orders over ₹499 qualify for free standard delivery. For orders below this value, a
                                nominal delivery fee of ₹40 applies.
                            </div>
                        </div>
                    </div>
                    <!-- FAQ 4 -->
                    <div class="accordion-item shadow-sm rounded-3 mb-3 border-0">
                        ...
                        <div id="faq4" class="accordion-collapse collapse" data-bs-parent="#martFaq">
                            <div class="accordion-body text-muted">
                                Once your order is out for delivery, you'll receive a WhatsApp link and an SMS
                                notification as tracking your Elite Mart delivery agent live on our system.
                            </div>
                        </div>
                    </div>
                    <!-- FAQ 5 -->
                    <div class="accordion-item shadow-sm rounded-3 mb-3 border-0">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed fw-bold rounded-3" type="button"
                                ...
                                Can I schedule a specific delivery slot?
                            </button>
                        </h2>
                        <div id="faq5" class="accordion-collapse collapse" data-bs-parent="#martFaq">
                            <div class="accordion-body text-muted">
                                Yes, we offer multiple 2-hour delivery slots from 7 AM to 9 PM daily. You can select
                                your preferred slot at the checkout page.
                            </div>
                        </div>
                    </div>
                    <!-- FAQ 6 -->
                    <div class="accordion-item shadow-sm rounded-3 mb-3 border-0">
                        ...
                        <div id="faq6" class="accordion-collapse collapse" data-bs-parent="#martFaq">
                            <div class="accordion-body text-muted">
                                We have a 'No Questions Asked' return policy for fresh produce. If you're not satisfied
                                with the quality, we offer an "on-the-spot" return or instant replacement during
                                delivery.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item shadow-sm rounded-3 mb-3 border-0">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed fw-bold rounded-3" type="button"
                                ...
                                Do you provide organic-only options?
                            </button>
                        </h2>
                        <div id="faq7" class="accordion-collapse collapse" data-bs-parent="#martFaq">
                            <div class="accordion-body text-muted">
                                Yes, our 'Elite Organic' range features 100% certified organic vegetables and grains,
                    ...
                    <div class="accordion-item shadow-sm rounded-3 mb-3 border-0">
                        ...
                        <div id="faq8" class="accordion-collapse collapse" data-bs-parent="#martFaq">
                            <div class="accordion-body text-muted">
                                We accept multiple payment methods including UPI (PhonePe, Google Pay), Credit/Debit
                    ...
                    <div class="accordion-item shadow-sm rounded-3 mb-3 border-0">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed fw-bold rounded-3" type="button"
                                ...
                                Are there any bulk discounts for events or businesses?
                            </button>
                        </h2>
                        <div id="faq9" class="accordion-collapse collapse" data-bs-parent="#martFaq">
                            <div class="accordion-body text-muted">
                                Absolutely! Please check our 'B2B & Bulk' section or contact our support team for
                                specialized corporate pricing and family-event packages.
                            </div>
                        </div>
                    </div>
                    <!-- FAQ 10 -->
                    <div class="accordion-item shadow-sm rounded-3 mb-3 border-0">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed fw-bold rounded-3" type="button"
                                ...
                                Do you deliver in eco-friendly packaging?
                            </button>
                        </h2>
                        <div id="faq10" class="accordion-collapse collapse" data-bs-parent="#martFaq">
                            <div class="accordion-body text-muted">
                                We are committed to sustainability! We use recyclable paper bags and offer plastic-free,
                                biodegradable packaging options upon request at checkout.
                            </div>
                        </div>
                    </div>
                </div>
